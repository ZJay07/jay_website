  ...
  return (
    <section id="work" className="py-16 bg-gray-100 dark:bg-gray-800">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8 text-purple-600 dark:text-purple-400">Related Work</h2>
        <div className="space-y-8">
          {/* Ivy Contributions */}
          <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-2">Open-Source Contributions to Ivy</h3>
          ...
          <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-2">Bias Mitigation in Stable Diffusion</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
