...
function ExperienceCard({ title, company, date, points, logo, index }: {
  title: string
  company: string
  date: string
  points: string[]
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <h3 className="text-xl font-semibold text-[#0f172a] dark:text-[#94a3b8]">{title}</h3>
          <p className="text-[#64748b]">{company} | {date}</p>
        </div>
      </div>
